...
// chky  annotate
// ps   - pointer to next part of the cmd
// *q   - pointer to first non-whitespace character, usually <|>
// *eq  - pointer to first whitespace or symbol character after *q
// return 'a' on error, usually <|>
int
...
// chky annotate:
// find pointer to first occurrance of non-whitespace characters in toks[]
// store it in *ps
